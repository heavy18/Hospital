				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<input type="hidden" name="userid" value="${userObj.id }">
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Age</label> <input required
									 type="number" class="form-control" name="age">
							</div>
							
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Appointment Date</label> <input 
									 type="date"  min="2023-07-27" max="2023-09-26"
									  class="form-control"  required name="appoint_date">
							</div>
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Phone No </label> <input 
									 min="10"  required type="number" class="form-control" name="phno">
							</div>
